...
var Speedometer =
  ...
  (function (_Component) {
    ...
    function Speedometer(props) {
      ...
      _this.speedometerValue = new reactNative.Animated.Value(
        props.defaultValue,
      );
      return _this;
    }
    ...
    _proto.render = function render() {
      ...
      var label = calculateLabelFromValue(
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            reactNative.Text,
            {
              style: {color: this.props.color, ...style.label, ...labelStyle}, //[style.label, labelStyle],
            },
            limitValue(value, minValue, maxValue, allowedDecimals) +
              ' ' +
              this.props.suffix,
